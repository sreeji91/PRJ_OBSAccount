...
public class POMAddProduct {
	...
	public void add_product() throws Exception {
		...
		objWait.presenceOfElementlocated(By.xpath("//input[@id='name']"), 3);
		objActions.screenshot();
		product_name.sendKeys(PropertyReadUtility.readConfigFile("product_name"));
		//objActions.sendkeys(product_name,PropertyFileRead.readConfigFile("product_name") );
